...
- Different model architectures (linear, polynomial, decision tree, ensemble, neural net)
- Feature engineering (interactions, polynomials, binning)
- Hyperparameter tuning (learning rate, regularization, tree depth, etc.)
- Ensemble methods (bagging, boosting, stacking)
- Only use standard library + numpy + scikit-learn (if available)
